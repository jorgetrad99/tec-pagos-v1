    ...
    <header>
        ...
        <nav class="nav">
            <div class="nav-menu flex-row">
                <div class="nav-brand">
                    <a href="http://www.itconkal.edu.mx/"><img src="../assets/tecnm.png" alt="Logo TECNM"></a>
                </div>
                <div class="toggle-collapse">
                    <div class="toggle-icons">
                        <img src="../assets/icons/bars.png" width="40rem" alt="Barras">
                    </div>
                </div>
                <div>
                    <ul class="nav-items">
                        <li class="nav-link"><a href="../views/home.php">Home</a><i>
                        <li class="nav-link"><a href="../views/inicio-sesion.php">Iniciar Sesión</a><i>
